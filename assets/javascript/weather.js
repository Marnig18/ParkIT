...
$("#submit").on("click", function(event){
  ...
  var queryURL = "http://proxy-weather-server.herokuapp.com/api/openweathermap/?q=" + city + "&units=imperial&appid=166a433c57516f51dfab1f7edaed8413"; 

  // "http://api.openweathermap.org/data/2.5/weather?q=" + city + "&units=imperial&appid=166a433c57516f51dfab1f7edaed8413"; 
